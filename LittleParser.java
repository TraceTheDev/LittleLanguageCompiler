...
public class LittleParser extends Parser {
	...
	public static final int
		...
		INTLITERAL=32, FLOATLITERAL=33, KEYWORD=34, IDENTIFIER=35, OPERATOR=36, 
		STRINGLITERAL=37, WS=38, COMMENT=39, WHITESPACE=40;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"KEYWORD", "IDENTIFIER", "OPERATOR", "STRINGLITERAL", "WS", "COMMENT", 
			"WHITESPACE"
		};
	}
